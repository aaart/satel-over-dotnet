...
{
    public class NoNotificationOutputEnqueueStateUpdateHandler : LoggingCapability, IEventHandler
    {
        private readonly int _ioIndex;
        private readonly ITaskQueue _queue;

        public NoNotificationOutputEnqueueStateUpdateHandler(int ioIndex, ITaskQueue queue)
        {
            _ioIndex = ioIndex;
            _queue = queue;
        }
